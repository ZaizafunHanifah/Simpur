...
Route::get('/logout', function () {
    if(session('api_token')) {
        Http::withToken(session('api_token'))->post('http://127.0.0.1:8000/api/logout');
    }
...
Route::group(['middleware' => [EnsureApiToken::class]], function () {
    ...
    Route::get('/dashboard', function () {
        ...
        $responseSurat = Http::withHeaders($headers)->get('http://127.0.0.1:8000/api/surat/masuk');
        $responseWarga = Http::withHeaders($headers)->get('http://127.0.0.1:8000/api/warga');
    ...
    Route::get('/admin/surat', function () {
        $token = session('api_token');
        $response = Http::withToken($token)->get('http://127.0.0.1:8000/api/surat/masuk');
    ...
    Route::get('/admin/surat/{id}', function ($id) {
        $token = session('api_token');
        $response = Http::withToken($token)->get('http://127.0.0.1:8000/api/surat/' . $id);
    ...
    Route::get('/admin/surat/{id}/download', function (Request $request, $id) {
        ...
        $response = Http::withToken($token)->get('http://127.0.0.1:8000/api/surat/' . $id . '/pdf', $request->query());
    ...
    Route::put('/admin/surat/{id}/verify', function ($id) {
        $response = Http::withToken(session('api_token'))->put('http://127.0.0.1:8000/api/surat/'.$id.'/verify');
    ...
    Route::put('/admin/surat/{id}/reject', function ($id) {
        $response = Http::withToken(session('api_token'))->put('http://127.0.0.1:8000/api/surat/'.$id.'/reject');
    ...
    Route::put('/admin/surat/{id}/sign', function (Request $request, $id) {
        $response = Http::withToken(session('api_token'))->put('http://127.0.0.1:8000/api/surat/'.$id.'/sign', [
    ...
    Route::delete('/admin/surat/{id}', function ($id) {
        $response = Http::withToken(session('api_token'))->delete('http://127.0.0.1:8000/api/surat/' . $id);
    ...
    Route::get('/admin/warga', function () {
        $token = session('api_token');
        $response = Http::withToken($token)->get('http://127.0.0.1:8000/api/warga');
        $json = $response->json() ?? [];
    ...
    Route::post('/admin/warga', function (Request $request) {
        $token = session('api_token');
        $response = Http::withToken($token)->post('http://127.0.0.1:8000/api/warga', $request->all());
    ...
    Route::delete('/admin/warga/{id}', function ($id) {
        $token = session('api_token');
        $response = Http::withToken($token)->delete('http://127.0.0.1:8000/api/warga/' . $id);
    ...
    Route::get('/admin/berita', function () {
        $token = session('api_token');
        $response = Http::withToken($token)->get('http://127.0.0.1:8000/api/berita');
    ...
    Route::post('/admin/berita', function (Request $request) {
        $token = session('api_token');
        $response = Http::withToken($token)->post('http://127.0.0.1:8000/api/berita', $request->all());
    ...
    Route::delete('/admin/berita/{id}', function ($id) {
        $token = session('api_token');
        $response = Http::withToken($token)->delete('http://127.0.0.1:8000/api/berita/' . $id);
...
Route::get('/berita', function () {
    try {
        $response = Http::get('http://127.0.0.1:8000/api/berita/list');
        $berita = $response->successful() ? ($response->json() ?? []) : [];
    } catch (\Exception $e) {
        $berita = [];
    }
...
Route::get('/pengajuan', function () {
    ...
    try {
        $response = Http::get('http://127.0.0.1:8000/api/templates');
